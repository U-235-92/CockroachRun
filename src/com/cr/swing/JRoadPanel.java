...
public class JRoadPanel extends JPanel {
	...
	private int number_road;
	
	private Cockroach cockroach;
	
	private JLabel label;
	
	public JRoadPanel(int number_road) {
		...
		addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(cockroach.getGui_constructror().is_start_game()) {
	...
	public void paintComponent(Graphics g) {
		...
		g.drawString("#" + number_road, 500, HEIGHT_ROAD / 2);
